...
def track_info(tbody, fp):
	...
	info[tds[2].string] = tds[3].string
	for i in range(17):
		info[tds[i*2+5].string] = tds[i*2+6].string	
	print(repr(info))
	fp.write(repr(info)+'\n')
	return
...
if __name__ == "__main__":
	...
	result_file = 'shanxi_law.txt'	
	detail_file = 'shanxi_detail.txt'
	...
	for line in fp:
		...
		cnt += 1
		url = url_prefix + line[line.index("/lvshiD.aspx?id"):].strip()
