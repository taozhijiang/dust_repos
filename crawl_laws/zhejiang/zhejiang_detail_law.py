...
def track_info(tbody, fp):
	...
	for i in range(10):
		if tds[i*2+1].string:
			info[tds[i*2].div.string.strip()] = tds[i*2+1].string.strip()
		else:
			info[tds[i*2].div.string.strip()] = ""
	fp.write(repr(info)+'\n')
	return
...
if __name__ == "__main__":
	...
	detail_file = 'zhejiang_detail.txt'
	...
	for line in fp:
		...
		cnt += 1
		url = line[line.index("http://www.zjbar.com/lawyer"):].strip()
